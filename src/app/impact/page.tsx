    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-14">
          <span className="label-neu text-fn-teal-fonce block mb-5">Impact</span>
      ...
      >
        <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-14">
          ...
          {/* Projections 2030 */}
          <div className="card-neu-accent">
            <h3 className="font-accent font-semibold text-lg text-fn-texte-titre mb-8 tracking-wide">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div>
                ...
                <p className="label-neu mb-2">Serres Répliquées</p>
              ...
              <div>
                ...
                <p className="label-neu mb-2">Emplois Agricoles</p>
                <p className="font-corps text-sm text-fn-texte-muted leading-relaxed">
              ...
              <div>
                ...
                <p className="label-neu mb-2">Tonnes Annuelles</p>
                <p className="font-corps text-sm text-fn-texte-muted leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-14">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            <div className="card-neu">
              ...
              <ul className="space-y-3 font-corps text-sm text-fn-texte-sub">
